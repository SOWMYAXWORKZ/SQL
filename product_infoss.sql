CREATE DATABASE product_infoss;
CREATE TABLE product_infoss (
...
SELECT * FROM product_infoss;
INSERT INTO product_infoss (product_id, product_name, category, price, stock_quantity, supplier, manufacture_date) VALUES
