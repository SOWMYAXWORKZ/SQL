CREATE DATABASE order_infoss;
CREATE TABLE order_infoss (
...
INSERT INTO order_infoss (order_id, order_date, customer_id, product_id, quantity, total_price, status) 
VALUES
...
SELECT * FROM order_infoss;
ALTER TABLE order_infoss
